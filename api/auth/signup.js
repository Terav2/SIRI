...
function getEmailTemplate(magicLink) {
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
      ...
      <div style="background: #f9fafb; border-radius: 12px; padding: 32px; text-align: center;">
        ...
        <p style="font-size: 14px; color: #9ca3af; margin: 32px 0 0 0;">If you did not request this email, you can safely ignore it.</p>
      </div>
    ...
    if (process.env.RESEND_API_KEY) {
      try {
        await resend.emails.send({
          from: 'Sio <onboarding@resend.dev>',
          to: normalizedEmail,
          subject: 'Your Sio Magic Link',
          html: getEmailTemplate(magicLink),
        });
